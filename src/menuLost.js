export default class MenuLost extends Phaser.Scene{
    constructor(){
        super({key: 'menuLost'})
    }

    create(){
        this.tittle = this.add.text(180,60,"GAMEOVER", {fontSize: '80px', fontFamily: 'bitdragon',fill: '#cd1919ff'}).setOrigin(0,0);
